...
import kotlinx.android.synthetic.main.fragment_json_parse.view.*
 ...
 * @Called
 */
class JsonParseFragment :BaseFragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_json_parse,container,false).apply {
